...
在游戏中，绿宝石是非常重要的资源。 以下将会介绍几种非常常见的赚钱方法
...
:::tip
如果穿上带有Loot Bonus的装备，获取稀有物品的概率会更大
...
![](/assets/img/basic/seavale_reef.jpg)
...
:::tip
强烈建议读者做完[Underwater(level 8)](https://wynncraft.wiki.gg/wiki/Underwater)或者[Underice(level 43)](https://wynncraft.wiki.gg/wiki/Underice)之后，佩戴任务中获得的潜水头盔再进行海底捞，可以减少换气时间，效率会高很多！

wynn目前有一个特性，就是你在游泳状态下向上顶到方块会把呼吸条直接回满
:::
...
举个非常简单的例子：[An Iron Heart Part II](https://wynncraft.wiki.gg/wiki/An_Iron_Heart_Part_II)任务中，

最终奖励可以选择一条非常强力的经验裤子`Greaves of honor`

由于获取途径只有这个任务，因此价格算是比较昂贵。

同时如果你能鉴定出非常高的经验鉴定值，那价格更是能翻个数倍(其实去鉴定算是赌博，鉴定烂了就完了)
...
:::tip
一些世界事件有一定的解锁条件（如下图这个需要完成[Ice Nations](https://wynncraft.wiki.gg/wiki/Ice_Nations)）
:::
...
什么？不知道TNA是什么？还不快看看[这篇文章](/advanced/raid/tna)
...
对于lootrun，可以看看[这一章](/advanced/lr/basic)
